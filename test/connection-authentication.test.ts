...
test('mac', () => {
    ...
    let macPeerUsesToSendUsTheMessage = peerConnectionAuth.getMac(msg, peerSequence, peerSendingMacKey);

    let result = connectionAuth.verifyMac(macPeerUsesToSendUsTheMessage, receivingMacKey, Buffer.concat([peerSequence, msg]));
